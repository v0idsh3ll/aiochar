...
class Reply:
    def __init__(
        ...
        self.parent_post_id = int(parent_post_id)

    def to_dict(self) -> dict:
        """
        Convert a reply to a dict

        :return: Dict with reply data
        """
...
class Post:
    ...
    def __new__(cls, **kwargs):
        if "parent_post_id" in kwargs and kwargs['parent_post_id'] is not None:
            instance = Reply.__new__(Reply)
